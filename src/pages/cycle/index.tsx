        ...
        <CardContent className="pt-0">
          <View className="mb-4">
            ...
            <Picker mode="date" value={cycleStartDate} onChange={handleDateChange}>
              <View className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 border border-gray-200">
                <View className="flex items-center gap-2">
          ...
          <View className="mb-4">
            ...
            <View className="flex flex-wrap gap-2">
              {lengthOptions.map((len) => (
                ...
                >
                  <Text className="block text-sm" style={{ color: cycleLength === len ? '#F7F8FA' : '#6B7280' }}>
                    {len}天
                  </Text>
                </View>
              ))}
          ...
          <Button
            className="w-full"
            style={{ backgroundColor: '#EC4899', color: '#F7F8FA' }}
            onClick={handleSave}
            disabled={saving}
          >
