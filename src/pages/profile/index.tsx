...
const ProfilePage: FC = () => {
  ...
  return (
    <View className="min-h-screen bg-gray-50 pb-20">
      {/* 用户信息卡片 */}
      <View className="p-4">
        <Card className="shadow-sm border-0 bg-black">
              ...
              {isWeapp ? (
                ...
                >
                  {profile.avatarUrl ? (
                    ...
                    <View className="w-16 h-16 rounded-full bg-gray-700 flex items-center justify-center">
      ...
      <View className="p-4 mt-2">
        <View className="grid grid-cols-3 gap-3">
          ...
          <Card className="shadow-sm border-0">
            <CardContent className="p-3 text-center">
              <Text className="block text-2xl font-bold text-emerald-500">{stats.compatibility}%</Text>
