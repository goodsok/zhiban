...
const phaseConfig: Record<string, { icon: typeof Heart; color: string; bgColor: string; textColor: string }> = {
  ...
  follicular: { icon: Sun, color: '#10B981', bgColor: 'bg-emerald-50', textColor: 'text-emerald-600' },
  ...
  return (
    <View className="min-h-screen bg-gray-50 pb-6">
      ...
      <View className="mx-4 mt-4">
        ...
        <View className="bg-white rounded-xl border border-gray-100 p-4 space-y-3">
          ...
          {knowledge.characteristics?.social && (
            <View className="flex items-start gap-3">
              <View className="w-6 h-6 rounded-full bg-emerald-50 flex items-center justify-center shrink-0 mt-1">
      ...
      {knowledge.recommendations && (
        <View className="mx-4 mt-4">
          ...
          {knowledge.recommendations.best_actions && knowledge.recommendations.best_actions.length > 0 && (
            <View className="bg-white rounded-xl border border-gray-100 p-4 mb-2">
              ...
              <View className="space-y-2">
                {knowledge.recommendations.best_actions.map((action, index) => (
                  <View key={index} className="flex items-start gap-2">
                    <View className="w-2 h-2 rounded-full bg-emerald-500 mt-2 shrink-0" />
