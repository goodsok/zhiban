    ...
    <View className="min-h-screen bg-gray-50 pb-24">
      ...
      <View className="px-4 py-4">
        <View className="flex gap-4">
          <View className="flex-1 bg-white rounded-xl border border-gray-100 p-4 text-center">
      ...
      <View className="px-4">
        {loading ? (
          ...
          <View className="text-center py-12">
            ...
            <Button className="bg-black" onClick={goToCreate}>
      ...
      <View className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100">
        <Button className="w-full bg-black" onClick={goToCreate}>
          <Plus size={16} color="#fff" />
