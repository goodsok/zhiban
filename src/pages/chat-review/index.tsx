              ...
              <Card className="mb-4">
                <CardContent className="p-4">
                  ...
                  <View className="flex flex-row items-center mb-2">
                    ...
                    <TrendIcon size={14} color={trendConfig[analysis.emotionState.trend]?.color === 'text-emerald-600' ? '#10B981' : trendConfig[analysis.emotionState.trend]?.color === 'text-red-500' ? '#EF4444' : '#6B7280'} className="ml-2" />
                    <Text className="block text-sm ml-1" style={{ color: trendConfig[analysis.emotionState.trend]?.color === 'text-emerald-600' ? '#10B981' : trendConfig[analysis.emotionState.trend]?.color === 'text-red-500' ? '#EF4444' : '#6B7280' }}>{analysis.emotionState.trend}</Text>
                  </View>
