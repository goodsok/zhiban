...
export const layer1Dimensions: DimensionDefinition[] = [
  ...
  },
  {
    ...
    data_type: 'string',
    enum_options: [
      { value: 'open_high', label: '高开放性-好奇创新' },
      { value: 'con_high', label: '高尽责性-严谨自律' },
      { value: 'ext_high', label: '高外向性-热情社交' },
      { value: 'agr_high', label: '高宜人性-信任合作' },
      { value: 'neu_low', label: '低神经质-情绪稳定' },
      { value: 'open_con', label: '开放+尽责型' },
      { value: 'open_ext', label: '开放+外向型' },
      { value: 'con_agr', label: '尽责+宜人型' },
      { value: 'balanced', label: '均衡型' }
    ],
    input_type: 'select',
    placeholder: '请选择主要人格特征',
    help_text: '选择最突出的性格特征',
    weight: 1.3,
    importance: 'important',
    source_allowed: ['manual', 'questionnaire'],
    sort_order: 52
