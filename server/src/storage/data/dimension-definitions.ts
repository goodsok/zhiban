...
export const layer1Dimensions: DimensionDefinition[] = [
  ...
  },
  {
    ...
    enum_options: [
      ...
      { value: 'pessimistic', label: '悲观现实' },
      { value: 'pragmatic', label: '务实理性' },
      { value: 'idealist', label: '理想主义' },
      { value: 'skeptical', label: '怀疑主义' },
      { value: 'stoic', label: '斯多葛主义' },
      { value: 'existentialist', label: '存在主义' },
      { value: 'spiritual', label: '灵性主义' },
      { value: 'materialist', label: '唯物主义' },
      { value: 'humanist', label: '人文主义' }
    ],
    input_type: 'multiselect',
...
export const layer2Dimensions: DimensionDefinition[] = [
  ...
  },
  {
    ...
    display_name: '过往恋爱模式',
    description: '在过往恋爱经历中表现出的典型模式',
    layer: 2,
    category: 'love_style',
    data_type: 'string[]',
    enum_options: [
      { value: 'long_term', label: '倾向于长期关系' },
      { value: 'short_term', label: '倾向于短期关系' },
      { value: 'serial_monogamy', label: '连续单一伴侣' },
      { value: 'intense_start', label: '热烈开始后平淡' },
      { value: 'slow_burn', label: '慢热型逐渐深入' },
      { value: 'on_off', label: '分分合合' },
      { value: 'unavailable', label: '总被不可得的人吸引' },
      { value: 'rescuer', label: '拯救者模式' },
      { value: 'pleaser', label: '讨好型伴侣' },
      { value: 'controller', label: '控制型伴侣' },
      { value: 'avoidant', label: '亲密后疏远' },
      { value: 'anxious', label: '焦虑型依恋' },
      { value: 'people_pleaser', label: '总是迁就对方' },
      { value: 'self_sacrifice', label: '过度牺牲自我' },
      { value: 'repeated_mistakes', label: '重复同样的错误' },
      { value: 'learned_grown', label: '从过往中成长' }
    ],
    input_type: 'multiselect',
    placeholder: '请选择过往恋爱模式',
    weight: 1.2,
    importance: 'important',
    source_allowed: ['manual'],
    sort_order: 154
